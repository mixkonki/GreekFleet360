...
class TestCostEnginePersistence(TestCase):
    ...
    def setUp(self):
        ...
        self.cost_center = CostCenter.all_objects.create(
        ...
        self.transport_order = TransportOrder.all_objects.create(
            company=self.company,
    ...
    def test_save_cost_rate_snapshots(self):
        ...
        # Verify KM snapshot
        km_snapshot = CostRateSnapshot.all_objects.get(
            company=self.company,
    ...
    def test_save_order_cost_breakdowns(self):
        ...
        # Verify breakdown
        breakdown = OrderCostBreakdown.all_objects.get(
            company=self.company,
    ...
    def test_save_snapshots_replaces_existing(self):
        ...
        snapshot_count = CostRateSnapshot.all_objects.filter(
            company=self.company,
            period_start=self.period_start,
            period_end=self.period_end
        ).count()
